...
import { AuthCard, GoogleLogo } from "@/components/auth-card"
...
function LoginContent() {
    ...
    const handleGoogleClick = () => {
        ...
        // If the user closes the prompt without selecting an account
        ...
        <AuthCard>
            ...
            {success && (
                <div style={{ textAlign: 'center', padding: '20px 0' }}>
                    ...
                    <p style={{ color: '#86efac', fontSize: '14px', fontWeight: 500 }}>Signed in! Redirecting…</p>
                </div>
            )}
